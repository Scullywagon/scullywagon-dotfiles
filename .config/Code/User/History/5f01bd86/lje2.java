...
public class Main 
{
    ...
    */    
    ...
    {
        Musician.Band band = new Musician.Band(5, "Rock", "Loaded Dipers");
        Musician musician = new Musician("Guitar", band);

        musician.musicianInfo.setAvailable(true);
        musician.musicianInfo.printInfo();

        musician.printFestival();
    }


    // Exercise 5 -- enum and ordinal position
    public static void ColourOrdinalPos()
    {
        Colours c = Colours.BLUE;

        System.out.println(c.ordinal());

        for (Colours r : Colours.values())
        {
